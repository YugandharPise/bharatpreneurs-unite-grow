      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              A premium community for Indian entrepreneurs building tomorrow's successful businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#success-stories" className="footer-link">Success Stories</a></li>
              <li><a href="#offerings" className="footer-link">Our Offerings</a></li>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row">
              ...
              <button type="submit" className="bg-gold text-black px-4 py-2 rounded-r-md mt-2 sm:mt-0">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Bharatpreneurs. All rights reserved.
          </p>
